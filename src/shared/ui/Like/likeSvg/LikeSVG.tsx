import styles from "./likeSVG.module.scss";

export const LikeEmpty = ({ isUser }: { isUser: boolean }) => {
  const classEmpty = isUser ? styles.likeEmptyNonUser : styles.likeEmptyPath;
...
export const LikePaintedOver = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    viewBox="0 0 24 24"
    className={styles.likePaintedOver}
  >
    <path
