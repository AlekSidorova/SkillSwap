...
// Добавлен функционал для type="password". Если передать флаг isShowPassword в пропс, то форма будет сразу с открытым паролем, а если не передать, то с закрытым. Удобно будет использовать для разных задач (авторизация и регистрация).
